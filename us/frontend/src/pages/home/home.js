          ...
          <div className="row">
            <div className="col-lg-7 col-md-12 col-sm-12 leftContent">
              ...
              <p>
                ...
                education and to show ‘the path of spiritual righteousness’, to
                ‘foster human values and welfare with esteemed devotion indeed’.
              </p>
              <p>
                Harinder, BJS Managing Director, explains that he believes in a
                divine flow and his team;
              </p>
                ...
                <div className="row">
                  <div className="col-8 p-0">
                    <p>
                      ...
                      shouldn’t be ignored within the world of work. There is no
                      division in our hearts before you start work and after you
                      sit at your desk or the cab of a truck. By respecting my
                      team and treating them with compassion and kindness they
                      are better able to continue that conduct to the benefit of
                      everyone they encounter, including our customers. It is
                      what has set us apart as a business.{" "}
                    </p>
                  </div>
